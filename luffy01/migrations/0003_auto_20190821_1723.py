# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2019-08-21 09:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('luffy01', '0002_auto_20190820_1123'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='luffy01.Userinfo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='luffy01.Userinfo', verbose_name='会员名')),
                ...
                ('p_node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='luffy01.Comment', verbose_name='父级评论')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='article',
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='luffy01.ArticleSource', verbose_name='来源'),
        ),
